...
export class ApiPath {
  ...
  public static RETURN_OUTPUT_LIST_TABLE = environment.apiBaseUrl.concat(ApiPathConfig.list_table.list);

  public static RETURN_OUTPUT_ADD_TABLE = environment.apiBaseUrl.concat(ApiPathConfig.list_table.add);

  public static RETURN_OUTPUT_UPDATE_TABLE = environment.apiBaseUrl.concat(ApiPathConfig.list_table.update);

  public static RETURN_OUTPUT_FIND_TABLE = environment.apiBaseUrl.concat(ApiPathConfig.list_table.find);

  public static RETURN_OUTPUT_DELETE_TABLE = environment.apiBaseUrl.concat(ApiPathConfig.list_table.delete);

  public static RETURN_OUTPUT_SHOW_PAGE_SEARCH_TABLE = environment.apiBaseUrl.concat(ApiPathConfig.list_table.find);

  //PRODUCT
  public static RETURN_OUTPUT_LIST_PRODUCT = environment.apiBaseUrl.concat(ApiPathConfig.product_table.list)
  public static RETURN_OUTPUT_SHOW_PAGE_SEARCH_PRODUCT = environment.apiBaseUrl.concat(ApiPathConfig.product_table.find);
  public static RETURN_OUTPUT_ADD_PRODUCT = environment.apiBaseUrl.concat(ApiPathConfig.product_table.add);
  public static RETURN_OUTPUT_UPDATE_PRODUCT = environment.apiBaseUrl.concat(ApiPathConfig.product_table.update);
  public static RETURN_OUTPUT_DELETE_PRODUCT = environment.apiBaseUrl.concat(ApiPathConfig.product_table.delete);
  public static RETURN_OUTPUT_FINDNAMEBYCODE_PRODUCT = environment.apiBaseUrl.concat(ApiPathConfig.product_table.findNameByCode);

  //OWNER

  public static RETURN_OUTPUT_LIST_OWNER = environment.apiBaseUrl.concat(ApiPathConfig.owner_table.list)
  public static RETURN_OUTPUT_SHOW_PAGE_SEARCH_OWNER = environment.apiBaseUrl.concat(ApiPathConfig.owner_table.find);
  public static RETURN_OUTPUT_ADD_OWNER = environment.apiBaseUrl.concat(ApiPathConfig.owner_table.add);
  public static RETURN_OUTPUT_UPDATE_OWNER = environment.apiBaseUrl.concat(ApiPathConfig.owner_table.update);
  public static RETURN_OUTPUT_DELETE_OWNER = environment.apiBaseUrl.concat(ApiPathConfig.owner_table.delete);
  public static RETURN_OUTPUT_FINDNAMEBYCODE_OWNER = environment.apiBaseUrl.concat(ApiPathConfig.owner_table.findNameByCode);

  //SUPPLIER

  public static RETURN_OUTPUT_LIST_SUPPLIER = environment.apiBaseUrl.concat(ApiPathConfig.supplier_table.list)
  public static RETURN_OUTPUT_SHOW_PAGE_SEARCH_SUPPLIER = environment.apiBaseUrl.concat(ApiPathConfig.supplier_table.find);
  public static RETURN_OUTPUT_ADD_SUPPLIER = environment.apiBaseUrl.concat(ApiPathConfig.supplier_table.add);
  public static RETURN_OUTPUT_UPDATE_SUPPLIER = environment.apiBaseUrl.concat(ApiPathConfig.supplier_table.update);
  public static RETURN_OUTPUT_DELETE_SUPPLIER = environment.apiBaseUrl.concat(ApiPathConfig.supplier_table.delete);
  public static RETURN_OUTPUT_FINDNAMEBYCODE_SUPPLIER = environment.apiBaseUrl.concat(ApiPathConfig.supplier_table.findNameByCode);

   //WARE_HOUSE

   public static RETURN_OUTPUT_LIST_WAREHOUSE = environment.apiBaseUrl.concat(ApiPathConfig.wareHouse_table.list)
   public static RETURN_OUTPUT_SHOW_PAGE_SEARCH_WAREHOUSE = environment.apiBaseUrl.concat(ApiPathConfig.wareHouse_table.find);
   public static RETURN_OUTPUT_ADD_WAREHOUSE = environment.apiBaseUrl.concat(ApiPathConfig.wareHouse_table.add);
   public static RETURN_OUTPUT_UPDATE_WAREHOUSE = environment.apiBaseUrl.concat(ApiPathConfig.wareHouse_table.update);
   public static RETURN_OUTPUT_DELETE_WAREHOUSE = environment.apiBaseUrl.concat(ApiPathConfig.wareHouse_table.delete);
   public static RETURN_OUTPUT_ONLYLIST_WAREHOUSE = environment.apiBaseUrl.concat(ApiPathConfig.wareHouse_table.onlyList);

   //LOCATION

   public static RETURN_OUTPUT_LIST_LOCATION = environment.apiBaseUrl.concat(ApiPathConfig.location_table.list)
   public static RETURN_OUTPUT_SHOW_PAGE_SEARCH_LOCATION = environment.apiBaseUrl.concat(ApiPathConfig.location_table.find);
   public static RETURN_OUTPUT_ADD_LOCATION = environment.apiBaseUrl.concat(ApiPathConfig.location_table.add);
   public static RETURN_OUTPUT_UPDATE_LOCATION = environment.apiBaseUrl.concat(ApiPathConfig.location_table.update);
   public static RETURN_OUTPUT_DELETE_LOCATION = environment.apiBaseUrl.concat(ApiPathConfig.location_table.delete);
   public static RETURN_OUTPUT_FIND_ID_WAREHOUSE_LOCATION = environment.apiBaseUrl.concat(ApiPathConfig.location_table.findIdWareHouse);

   //INVENTORYSTATUS

   public static RETURN_OUTPUT_LIST_INVENTORYSTATUS = environment.apiBaseUrl.concat(ApiPathConfig.inventoryStatus_table.list)
   public static RETURN_OUTPUT_SHOW_PAGE_SEARCH_INVENTORYSTATUS = environment.apiBaseUrl.concat(ApiPathConfig.inventoryStatus_table.find);
   public static RETURN_OUTPUT_ADD_INVENTORYSTATUS = environment.apiBaseUrl.concat(ApiPathConfig.inventoryStatus_table.add);
   public static RETURN_OUTPUT_UPDATE_INVENTORYSTATUS = environment.apiBaseUrl.concat(ApiPathConfig.inventoryStatus_table.update);
   public static RETURN_OUTPUT_DELETE_INVENTORYSTATUS = environment.apiBaseUrl.concat(ApiPathConfig.inventoryStatus_table.delete);
   public static RETURN_OUTPUT_ONLYLIST_INVENTORYSTATUS = environment.apiBaseUrl.concat(ApiPathConfig.inventoryStatus_table.onlyList);

   //TABLE_MASTER

   public static RETURN_OUTPUT_LIST_TABLE_MASTER = environment.apiBaseUrl.concat(ApiPathConfig.tableMaster_table.list)
   public static RETURN_OUTPUT_FIND_ID_TABLE_MASTER = environment.apiBaseUrl.concat(ApiPathConfig.tableMaster_table.find);
   public static RETURN_OUTPUT_ADD_TABLE_MASTER = environment.apiBaseUrl.concat(ApiPathConfig.tableMaster_table.add);
   public static RETURN_OUTPUT_UPDATE_TABLE_MASTER = environment.apiBaseUrl.concat(ApiPathConfig.tableMaster_table.update);
   public static RETURN_OUTPUT_DELETE_TABLE_MASTER = environment.apiBaseUrl.concat(ApiPathConfig.tableMaster_table.delete);
   public static RETURN_OUTPUT_FIND_BY_CHECK_DTO = environment.apiBaseUrl.concat(ApiPathConfig.tableMaster_table.findByCheckDto);
   public static RETURN_OUTPUT_UPDATE_OR_CREATE_TABLE_MASTER = environment.apiBaseUrl.concat(ApiPathConfig.tableMaster_table.updateOrCreate);
   public static RETURN_OUTPUT_SEARCH_PAGE_TABLE_MASTER = environment.apiBaseUrl.concat(ApiPathConfig.tableMaster_table.findSearchPage)

   // CHART_HISTORY
   
   public static RETURN_OUTPUT_CHART_HISTORY = environment.apiBaseUrl.concat(ApiPathConfig.chart_history.list)

   // LOGIN USER

   public static RETURN_OUTPUT_LOGIN_USER = environment.apiBaseUrl.concat(ApiPathConfig.login_user.list)
